...
import image2 from "../../public/single2.jpeg"
import image3 from "../../public/single3.jpeg"
import image4 from "../../public/single4.jpeg"
...
<div 
  className="relative overflow-hidden w-full h-[400px] flex items-center justify-center rounded-lg"
>
{/* <img
          src={selectedImage}
          alt="Product"
...
{/* <div className="flex gap-4 mt-4">
        ...
        <div className='space-y-2 ml-10'>
          ...
          <p className='text-xs font-semibold text-green-500'>(4 reviews)</p>
            ...
            <div>
              <span className="text-xl font-bold">$21.6</span> <span className="text-xl font-bold opacity-60">$24 </span> <span className="text-sm text-red-500 ">10% Off</span>
            </div>
          ...
          <span onClick={(e) => setCount(count - 1)}
          className="px-3 py-2 text-lg font-semibold border-r border-gray-300 w-full text-center text-gray-500 cursor-pointer">-</span>
         
          <span className="px-3 py-2 text-lg font-semibold w-full text-center text-gray-500">{count}</span>

          <span onClick={(e) => setCount(count + 1)}
          className="px-3 py-2 text-lg font-semibold border-l border-gray-300 w-full text-center text-gray-500 cursor-pointer">+</span>
          </div>
          ...
          <div className="grid grid-cols-2 opacity-60 mt-4 text-s">
            ...
            <div>
              ...
              <p className="mt-4" >01 day shipping. <span className="text-xs opacity-60">( Free pickup today)</span> </p>
